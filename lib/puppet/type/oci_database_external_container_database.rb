...
Puppet::Type.newtype(:oci_database_external_container_database) do
  include Puppet_X::EnterpriseModules::Oci::Type

  add_title_attributes(:external_container_database_name)

  ensurable

  parameter :name
  parameter :external_container_database_name
  parameter :tenant
