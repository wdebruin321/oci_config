...
Puppet::Type.newtype(:oci_database_external_pluggable_database) do
  include Puppet_X::EnterpriseModules::Oci::Type

  add_title_attributes(:external_pluggable_database_name)

  ensurable

  parameter :name
  parameter :external_pluggable_database_name
  parameter :tenant
  ...
  property :source
  property :source_id
  property :external_container_database
  property :external_container_database_id
  ...
  validate do
    ...
    validate_reference_propery(:external_container_database_id, self)
