    ...
    module Oci
      ...
      class ServiceInfo
        ...
        @information = [
          ...
          #
          [:unknown,                                    :peer_autonomous_container_database_compartment,
           'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :peer_autonomous_exadata_infrastructure,
           'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :peer_autonomous_vm_cluster, 'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :patch,                      'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :key_store,                  'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :database_software_image,    'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :maintenance_run,            'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :source_db_system,           'UNDEFINED',                                          'UNDEFINED',                               :compartment],
          [:unknown,                                    :kms_key_version,            'UNDEFINED',                                          'UNDEFINED',                               :compartment],
